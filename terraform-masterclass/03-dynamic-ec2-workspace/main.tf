...
# Network Modules
module "dev_network"  { source = "./modules/network"; vpc_cidr = "10.0.0.0/16"; env_name = "dev" }
module "prod_network" { source = "./modules/network"; vpc_cidr = "172.16.0.0/16"; env_name = "prod" }
